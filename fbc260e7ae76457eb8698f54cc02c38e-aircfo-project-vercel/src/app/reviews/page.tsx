...
export default function ReviewsPage() {
  const projectReviews = reviews.filter(r => r.type === 'project');

  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
        <div>
          <h1 className="text-4xl font-bold mb-2">Affiliate Projects</h1>
          <p className="text-muted-foreground">Discover and compare the best affiliate programs and projects.</p>
        </div>
