...
import { Star, CheckCircle, XCircle, ArrowRight, ExternalLink } from 'lucide-react';
  ...
  return (
    <article className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="mb-8">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">{review.title}</h1>
        <div className="flex items-center gap-6 text-sm text-muted-foreground mb-8">
          ...
          <span>Published on {new Date(review.createdAt).toLocaleDateString()}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="md:col-span-2">
          <div className="prose prose-lg dark:prose-invert max-w-none mb-12" dangerouslySetInnerHTML={{ __html: review.content }} />
        ...
        <div className="space-y-6">
          <div className="sticky top-24 p-6 border rounded-2xl bg-card shadow-sm">
            <h3 className="font-bold text-xl mb-4">Quick Verdict</h3>
            <div className="text-4xl font-bold text-primary mb-4">{review.rating}/5</div>
            <p className="text-sm text-muted-foreground mb-6">
              Highly recommended for those looking to scale their affiliate income with reliable tools.
            </p>
